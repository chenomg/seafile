...
# 暂时分开
function install_sea_mysql_ubuntu16() {
	cd /home/MyCloud
	#下载安装包6.2.3 64bit
	wget http://seafile-downloads.oss-cn-shanghai.aliyuncs.com/seafile-server_6.2.3_x86-64.tar.gz
	#解压
	...
	apt -y install python2.7 libpython2.7 python-setuptools python-imaging python-ldap python-urllib3 ffmpeg python-pip python-mysqldb python-memcache
...
echo "1.安装Seafile(SQLite, Centos7)"
echo "2.安装Seafile(MySQL, Ubuntu16.04)"
echo "3.卸载Seafile"
echo "4.退出"
declare -i stype
